...
const Footer = () => {
  return (
    <footer className="w-full mt-[120px]">
      <div className="w-full px-8 py-20 md:py-14 footer-mobile md:footer-tablet flex flex-col items-center gap-20 md:gap-10">
      ...
      <div className="w-full pt-16 pb-20 md:px-10 md:py-9 flex flex-col md:flex-row items-center bg-gray">
        <Link to="/">
          <Logo color="#fff" />
        </Link>
